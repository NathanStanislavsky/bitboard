...
enum Color { BLACK, WHITE, N_COLORS, NO_COLOR = N_COLORS };

enum Piece { PAWN, KNIGHT, BISHOP, ROOK, QUEEN, KING, N_PIECES, EMPTY = N_PIECES};
...
enum Square { A1, B1, C1, D1, E1, F1, G1, H1,
              ...
              A8, B8, C8, D8, E8, F8, G8, H8, N_SQUARES, NONE_SQUARE = N_SQUARES };
